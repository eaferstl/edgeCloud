...
| Language / Claim | Status | Notes |
|---|---|---|
| TODO | Not Started |  |

---

## 16. Prohibited or restricted claims

Legal team to complete.

Examples to review. Do not treat as final legal advice.

| Claim / Phrase | Status | Notes |
|---|---|---|
| Production-ready | Needs Review |  |
| Secure against arbitrary malicious devices | Needs Review |  |
| Fully decentralized | Needs Review |  |
| Compliance-ready | Needs Review |  |
| Privacy-preserving | Needs Review |  |
| Trustless | Needs Review |  |
| Enterprise-ready | Needs Review |  |
| Certified / audited | Needs Review |  |
| Safe for arbitrary untrusted code execution | Needs Review |  |
...
| Context | Required Language | Status |
|---|---|---|
| Demo presentation | TODO | Not Started |
| README / public repo | TODO | Not Started |
| Slides | TODO | Not Started |

---

## 18. Legal review checklist

- [ ] Master PRD reviewed for unsupported claims.
- [ ] Demo script reviewed.
- [ ] Presentation language reviewed.
- [ ] README reviewed if repo is public or shared externally.
- [ ] Known limitations reviewed.
- [ ] Any security/privacy/compliance claims reviewed.
