...
Resolution order: a team-local `spec.md` that conflicts with this file loses until reconciled. If this file and `docs/architecture.md` differ, reconcile them — `docs/architecture.md` is the technical source of truth, this file is the ratification/freeze record.
...
Derived from: `docs/architecture.md` (decisions ratified 2026-06-03)
Frozen: No
Frozen at: TODO
Approved by:
